...
extern "C"
JNIEXPORT jboolean Java_com_xxr0ss_antifrida_utils_AntiFridaUtil_checkFridaByPort(JNIEnv *env, jobject thiz,
                                                               jint port) {
    unused_param(thiz);
...
Java_com_xxr0ss_antifrida_utils_AntiFridaUtil_checkBeingDebugged(JNIEnv *env, jobject thiz,
    ...
    __android_log_print(ANDROID_LOG_ERROR, "JNI2", "test");
    long res = use_customized_syscall
               ? my_ptrace(PTRACE_TRACEME, 0, nullptr, 0)
               : ptrace(PTRACE_TRACEME, 0);
//    if (ptrace(PTRACE_TRACEME, 0, NULL, NULL) == -1) {
//        // Optionally, you can access errno directly for custom error handling:
//        switch (errno) {
//            case EPERM:
//                __android_log_print(ANDROID_LOG_INFO, TAG, "EPERM");
//                break;
//            case ESRCH:
//                __android_log_print(ANDROID_LOG_INFO, TAG, "ESRCH");
//                break;
//            case EACCES:
//                __android_log_print(ANDROID_LOG_INFO, TAG, "EACCES2");
//                break;
